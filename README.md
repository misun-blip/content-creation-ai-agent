...
- **一键全栈启动**：自动检测唤起 Docker，无缝拉起数据库、缓存与前后端生态
...
该脚本会自动：
1. **[新特性]** 自动检测并在后台拉起 Docker Desktop 环境。
2. 自动运行 `docker-compose` 拉起 MySQL 数据库和 Redis 缓存。
3. 自动安装依赖并启动 FastAPI 后端服务（http://localhost:8000）。
4. 自动启动 Vue 3 / Vite 前端服务（http://localhost:3000）。
...
> **注**：项目已完成全部 API 与模块的 100% 测试覆盖，`pytest` 测试用例与 Postman 全链路测试套件目前均为绿色通过状态。
...
详细的数据库设计请参考 [`文档集合/03-详细设计与接口/详细设计文档.md`](文档集合/03-详细设计与接口/详细设计文档.md)

## 项目文档

- [`文档集合/概要设计文档.md`](文档集合/02-总体设计/概要设计文档.md)：项目概要设计
- [`文档集合/详细设计文档.md`](文档集合/03-详细设计与接口/详细设计文档.md)：项目详细设计
- [`文档集合/项目定位与功能设计.md`](文档集合/01-项目背景与需求/项目定位与功能设计.md)：项目定位与功能设计
- [`文档集合/详细分工文档.md`](文档集合/04-研发管理/详细分工文档.md)：团队详细分工
- [`文档集合/接口设计文档.md`](文档集合/03-详细设计与接口/接口设计文档.md)：API接口设计
- [`文档集合/开发流程文档.md`](文档集合/04-研发管理/开发流程文档.md)：开发流程说明
- [`文档集合/测试报告.md`](文档集合/06-测试文档/测试报告.md)：测试报告
- [`文档集合/项目结题验收报告.md`](文档集合/06-测试文档/项目结题验收报告.md)：结课验收报告
